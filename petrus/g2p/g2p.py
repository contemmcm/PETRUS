...
PATH_HOMOGRAPHS_HETEROPHONES = os.path.dirname(__file__) +\
                               '/resources/homographs_heterophones.txt'
...
class G2PTranscriber(object):
    ...
    def is_oxytone(self, ts1, ts2, i):
        return True if self.is_tonic_syllable(ts1, ts2, i) and self.is_last_syllable(i) else False
    ...
    def transcriber(self):
        ...
        while i < tam:
            ...
            if word[i] == 'p':
                ...
                elif (tam - 2 > i and word[i + 1] == '-' and word[i + 2] == 's'
                ...
                elif (tam - 2 > i and word[i + 1] == '-' and word[i + 2] in T
                ...
                elif (tam - 2 > i and word[i + 1] == '-' and word[i + 2] in C and
                        not word[i + 2] in ['r', 'l']):
                    ipa = unichr(int('026A', 16))
                    w = w[:j] + 'k' + ipa + w[j + 1:]
                    j += 1
                ...
                elif (tam - 1 > i and word[i + 1] in C
                        and word[i + 1] not in ['l', 'r']):
                    ipa = unichr(int('026A', 16))
                    w = w[:j + 1] + ipa + w[j + 1:]
                    j += 1
                # Quando for seguido de consoante na seguinte sílaba
                elif (tam - 2 > i and word[i + 1] == '-'
                        and word[i + 2] in C
                ...
                elif (len(word) - 3 > i and word[i + 1] == 'u'
                ...
                if (tam - 1 > i and tam - 2 >= 0 and word[i - 1] == '-'
                ...
                elif (tam - 3 > i and word[i + 1] == '-' and
                        word[i + 2] == 'c' and word[i + 3] in T3):
                    w = w[:j] + '-' + 's' + w[j + 3:]
                    j += 1
                    i += 2
                # Quando 'sc' for seguido de 'a,á,à,â,o,ó,ô,u,ú,û'
                elif (tam - 3 > i and word[i + 1] == '-' and
                        word[i + 2] == 'c' and word[i + 3] in T4):
                    w = w[:j + 1] + '-' + 'k' + w[j + 3:]
                    j += 2
                    i += 2
                # Quando for seguida de h
            ...
            # Antes das consoantes p,t,c,q,f
                ...
                elif (tam - 1 > i and word[i + 1] in V + ['i', 'u']
                        and word[i - 1] == '-'
                        and word[i - 2] in V + ['i', 'u']):
                ...
                # considerar 'p' e 'b'
                elif (tam - 1 > i and word[i + 1] == '-' and word[i + 2] in C and
                        not word[i + 2] in ['p', 'b']):
                    ipa = unichr(int('026A', 16))
                ...
                # 'c,g'
                if (tam - 1 > i and word[i - 1] in T and word[i + 1] == '-' and
                        word[i + 2] in ['c', 'g', 'r']):
                    ipa = unichr(int('0273', 16))
                    w = w[:j] + ipa + w[j + 1:]
                # Quando não for seguida por 'hia'
                elif (tam - 2 > i and word[i + 1] == 'h' and
                        word[i + 2:i + 5] != "i-a"):
               ...
               # Fica com 'l':
                ...
                elif (tam - 3 > 1 and word[i - 1] == '-' and word[i - 2] == 'i' and
                        word[i - 3] in ['f', 'm']):
                    w = w[:j] + 'ks' + w[j + 1:]
                    j += 1
                # Quando a palavra tem 'fl' + 'e, u' + x
                elif (tam - 4 > 1 and word[i - 1] == '-' and
                      word[i - 2] in ['e', 'u'] and word[i - 4:i - 2] == 'fl'):
                    w = w[:j] + 'ks' + w[j + 1:]
                    j += 1
                ...
                elif (tam - 3 > i and word[i + 1] == '-' and word[i + 2] == 'c'
                        and word[i + 3] in T3):
                    w = w[:j] + 's' + w[j + 3:]
                    i += 2
                # Quando a palavra começa en 'f, m' + i + x
                elif (i - 3 == 0 and word[i - 1] == '-' and word[i - 2] == 'i' and
                        word[i - 3] in ['f', 'm']):
                    ipa = unichr(int('026A', 16))
                    w = w[:j] + 'k' + ipa + 's' + w[j + 1:]
                    j += 2
               # Quando ocorre 'e' no início da palavra + x + 'c,f,p,t'
                elif (tam - 1 > i and i - 1 == 0 and word[i - 1] == 'e' and
                        word[i + 1] == '-' and word[i + 2] in T2):
                    w = w[:j] + 's' + w[j + 1:]
                # Quando a palavra inicia com 'e, ê' + x + vogal + consoante
                elif (tam - 3 > i and i - 2 == 0 and word[i - 2] in ['e', 'ê'] and
                      word[i + 1] in V and word[i + 2] in C):
                    w = w[:j] + 'z' + w[j + 1:]
                # Quando a palavra inicia com 'e, ê' + x + vogal + consoante
                elif (tam - 3 > i and i - 2 == 0 and word[i - 2] in ['e', 'ê'] and
                      word[i + 1] in V and word[i + 2] == '-' and
                      word[i + 3] in C):
                    w = w[:j] + 'z' + w[j + 1:]
                # Quando a palavra inicia com 'ine' + x + vogal + consoante
                elif (tam - 3 > i and i - 5 == 0 and word[i - 5:i - 1] == 'i-ne'
                        and word[i + 1] in V + ['i'] and word[i + 2] in C):
                    w = w[:j] + 'z' + w[j + 1:]
                # Quando a palavra inicia com 'ine' + x + vogal + consoante
                elif (tam - 3 > i and i - 5 == 0 and
                        word[i - 5:i - 1] == 'i-ne' and word[i + 1] in V and
                        word[i + 2] == '-' and word[i + 3] in C):
                    w = w[:j] + 'z' + w[j + 1:]
                ...
                elif (tam - 1 > i and i - 1 == 0 and
                        word[i - 1] in ['e', 'ê'] and word[i + 1] == '-' and
                        word[i + 2] in C and word[i + 2] != 'v'):
                    w = w[:j] + 'z' + w[j + 1:]
                # Quando a palavra inicia com 'ine' + x + consoante (exceto 'v')
                elif (tam - 1 > i and i - 4 == 0 and
                        word[i - 4:i] == 'i-ne' and word[i + 1] == '-' and
                        word[i + 2] in C and word[i + 2] != 'v'):
                    w = w[:j] + 'z' + w[j + 1:]
                else:
                    ipa = unichr(int('0283', 16))
                ...
                T2 = ['e', 'é', 'ê', 'i', 'í']
                # Quando 'qu' for seguido de 'e' seguido 'n'
                if (len(word) - 3 > i and word[i + 1] == 'u'
                        and word[i + 2] in ['e', 'é', 'ê']
                        and word[i + 3] == 'n'):
                    ipa = unichr(int('028A', 16))
                    w = w[:j] + 'k' + ipa + w[j + 2:]
            ...
            # ---------------------------------------------------------------------
                ...
                elif (tam - 3 > i and word[i + 1] == 'm' and word[i + 2] == '-' and
                        word[i + 3] in ['p', 'b']):
                ...
                # iniciada por 'm, n'
                elif (tam - 2 > i and word[i + 1] == '-' and word[i + 2] in T1 and
                        self.is_tonic_syllable(ts1, ts2, i)):
                    w = w[:j] + 'ɐ͂' + w[j + 1:]
                    j += 1
                ...
                elif (tam - 3 > i and word[i + 1] == 'l' and word[i + 2] == '-' and
                        word[i + 3] in C):
                    ipa = unichr(int('028A', 16))
                    w = w[:j] + 'a' + ipa + w[j + 2:]
                    i += 1
                ...
                # iniciada por 'm, n'
                elif (len(word) - 1 > i and i == ts2 - 1 and word[i + 1] == '-' and
                        word[i + 2] in ['m', 'n']):
                    ipa = unichr(int('0250', 16))
                    w = w[:j] + ipa + w[j + 1:]
                ...
                elif (tam - 1 > i and (i == 0 or word[i - 1] == '-') and
                        word[i + 1] in T1):
                    w = w[:j] + 'ɐ͂' + w[j + 2:]
                    i += 1
                    j += 1
                ...
                elif (tam - 3 > i and i == 0 and word[i + 1] == '-'
                      and word[i + 2:i + 4] == 'xa'):
                    w = 'i' + w[j + 1:]
                # Quando fo
                elif (tam - 3 > i and i == 0 and word[i + 1] == 'x'
                        and word[i + 2] == '-'
                        and word[i + 3] in ['p', 't']):
                    w = 'i' + w[j + 1:]
                ...
                if (tam - 3 > i and word[i + 1] in T1 and word[i + 2] == '-' and
                        word[i + 3] in T2):
                    w = w[:j] + 'ẽɪ̃' + w[j + 2:]
                    i += 1
                    j += 3
                ...
                # (palavras oxítonas)
                elif (tam - 1 > i and self.is_tonic_syllable(ts1, ts2, i) and
                        word[i + 1] == 'l' and len(word) - 2 == i):
                ...
                elif (tam - 3 > i and self.is_tonic_syllable(ts1, ts2, i) and
                        word[i + 1] == '-' and word[i + 2:i + 4] in ['la', 'lo']
                ...
                elif (tam - 3 > i and word[i + 1] in T1 and word[i + 2] == '-' and
                        word[i + 3] in T3):
                ...
                elif (tam - 4 > i and word[i - 1] in ['c', 's']
                        and word[i + 1] == '-' and word[i + 2] == 'o'
                        and word[i + 3] == '-' and word[i + 4] == 'n'):
                ...
                # Quando for vogal tônica seguido de "l" em final de silaba
                # (palavras oxítonas)
                elif (tam - 2 == i and self.is_tonic_syllable(ts1, ts2, i) and
                        word[i + 1] == 'l'):
                ...
                elif (tam - 4 == i and word[i + 1] == '-' and word[i + 2] == 'o'
                        and word[i + 3] == 'u'):
                    ipa = unichr(int('028A', 16))
                    w = w[:j + 3] + ipa
                    i += 3
                ...
                # -----------------------------------------------------------------
                # Quando for seguida de 'm,n' na proxima sílaba
                if (tam - 2 > i and word[i + 1] == '-' and word[i + 2] in T1
                        and self.is_tonic_syllable(ts1, ts2, i)):
                    w = w[:j] + 'õ' + w[j + 1:]
                    j += 1
                # Quanfo for seguido de 'm,n' diante consoante velar 'c,g,r'
                ...
                elif (self.is_last_syllable(i) and
                        not self.is_tonic_syllable(ts1, ts2, i)):
                    ipa = unichr(int('028A', 16))
                    w = w[:j] + ipa + w[j + 1:]
                # Na sequência 'k, g' + 'u' + vogal ou se for ditongo
                elif (tam - 1 > i and word[i - 1] in ['k', 'g'] and
                        word[i + 1] in V):
                    ipa = unichr(int('028A', 16))
                    w = w[:j] + ipa + w[j + 1:]
                # Quando for vogal + 'u' + vogal
                elif (tam - 1 > i and word[i - 1] in V and word[i + 1] == '-' and
                        word[i + 2]in V):
                    ipa = unichr(int('028A', 16))
                    w = w[:j] + ipa + w[j + 1:]
                elif (tam - 1 > i and word[i - 1] == '-'
                        and word[i - 2] in V and word[i + 1] == '-'
                        and word[i + 2] in V):
                    ipa = unichr(int('028A', 16))
                    w = w[:j] + ipa + w[j + 1:]
